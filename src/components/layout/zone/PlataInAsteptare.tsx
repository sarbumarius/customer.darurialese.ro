...
/**
 * Zona: Plata in asteptare
 */
export interface PlataInAsteptareZoneActionsProps {
  order: Comanda;
...
export const PlataInAsteptareZoneActions: React.FC<PlataInAsteptareZoneActionsProps> = ({ order, movingCommandId, onPrecomanda, onLipsaPoze, onProcesare, onAnulare, onConfirmareOpen }) => {
...
export const PlataInAsteptareZone: React.FC = () => null;
export default PlataInAsteptareZone;
