 ...
 * Zona: Procesare
 */
export interface ProcesareZoneActionsProps {
  order: Comanda;
...
export const ProcesareZoneActions: React.FC<ProcesareZoneActionsProps> = ({ order, movingCommandId, onPrecomanda, onLipsaPoze, onAnulare, onConfirmareOpen }) => {
...
export const ProcesareZone: React.FC = () => null;
export default ProcesareZone;
